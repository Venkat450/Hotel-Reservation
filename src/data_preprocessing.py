...
class DataProcessor:
    ...
    def preprocess_data(self,df):
        try:
            ...
            for column in skewness[skewness>skew_treshold].index:
    ...
    def select_features(self,df):
        try:
            ...
            logger.error(f"Error during Feeature Selection step {e}")
    ...
    def process(self):
        try:
            ...
            logger.info("Data processig completed succesfully")
        except Exception as e:
