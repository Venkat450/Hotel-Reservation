...
class ModelTraining:
    ...
    def load_and_split_data(self):
        try:
            ...
            logger.error(f"Error while showing the data{e}")
    ...
    def train_lgbm(self, X_train, y_train):
        try:
            ...
            logger.info('Hyperparameter tuning is completerd')
    ...
    def run(self):
        try:
            with mlflow.start_run():
                ...
                logger.info("Logging the training and test datasets to MLFLOW")
                ...
                logger.info("Logging the parameters and metrics into MLFLOW")
